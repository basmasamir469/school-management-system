    ...
    <div style="display: none" class="row setup-content" id="step-1">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select my-1 mr-sm-2" wire:model="Nationality_Father_id">
                            <option value="" selected>{{trans('Parent_trans.Choose')}}...</option>
                ...
                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" wire:click="{{$updateMode?'firstStepSubmit_edit':'firstStepSubmit'}}"
